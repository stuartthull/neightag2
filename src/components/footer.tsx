        ...
        <footer className="main-footer">
            <div className="footer-container">
                ...
                <div className="footer-brand">
                    <p className="text-normal footer-title">NeighTag.com</p>
                    <p className="text-normal footer-copyright">
                        <Link to="/cookie-policy" className="text-normal footer-link">
                            Cookies
                        </Link>
                        {'  '}-{'  '}
                        <Link to="/privacy-policy" className="text-normal footer-link">
                            Privacy Policy
                        </Link>
                    </p>
                    <p className="text-normal footer-copyright">
                ...
                <ul className="footer-links">
                    <li>
                        <Link to="/" className="text-normal footer-link">
                            Home
                        </Link>
                    </li>
                    <li>
                        <Link to="/what-you-get" className="text-normal footer-link">
                            What do you get?
                        </Link>
                    </li>
                    <li>
                        <Link to="/shop" className="text-normal footer-link">
                            Shop
                        </Link>
                    </li>
                    <li>
                        <Link to="/about-us" className="text-normal footer-link">
                            About Us
                        </Link>
                    </li>
                    <li>
                        <Link to="/contact-us" className="text-normal footer-link">
                            Contact Us
                        </Link>
                    </li>
                    <li>
                        <Link to="/faqs" className="text-normal footer-link">
                            FAQs
                        </Link>
                    </li>
                </ul>
            ...
            <div className="social-container">
                <a
                    href="https://www.facebook.com/profile.php?id=61591144586371"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="footer-coffee-button"
                >
                    <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path d="m22 12c0-5.52-4.48-10-10-10s-10 4.48-10 10c0 4.99 3.66 9.13 8.44 9.88s0 0-.01-.01v-6.98h-2.53s-.01-.01-.01-.01v-2.89h2.54v-2.2c0-2.51 1.5-3.89 3.78-3.89 1.1 0 2.24.2 2.24.2s.01.01.01.01v2.46h-1.26c-1.24 0-1.63.77-1.63 1.56v1.87h2.76s.01.01.01.01l-.44 2.89h-2.33v6.99c4.78-.75 8.44-4.89 8.44-9.88h-.01z" />
                    </svg>
                    Facebook
                </a>
                <a
                    href="https://www.instagram.com/neigh_tag/"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="footer-coffee-button"
                >
                    <svg
                        data-gui="atds-icon-actions-icon"
