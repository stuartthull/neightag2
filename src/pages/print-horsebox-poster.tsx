...
export default function PrintHorseboxPoster(): React.JSX.Element {
        ...
        <div style={{ backgroundColor: '#ffffff', minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '20px' }}>
            ...
            <div className="dashboard-badge-print-area">
                ...
                <div className="dashboard-badge-footer-container">
                    <p className="dashboard-badge-footer-text">www.neightag.com</p>
                    <AccountSvg />
                </div>
            </div>
        </div>
